...
def clean_and_prepare_data(df):
    """Prepare data by creating primary addresses and updating donor statuses."""
    ...
    df = df.drop(columns=['Other Country.1', 'Other Major Gift Region.1', 'Other Primary Metro.1', 'Other Zip.1', 'Other State.1', 'Other City.1', 
        ...
        'A.8', 'Payments Received.1', 'A.9', 'Commitments (Balance Due).1', 
        'A.10', 'Expectancies (Balance Due).1', 'A.11', 'Last Amount', 'Last Designation', '# of Recognition Transactions.1', 'Number of Years of Recognition.1', 
        ' Campaign Recognition', 'A.12', 'One-Time Gifts.1', 'Commitments.1', 'A.13', 'A.14', 'Expectancies.1', 'A.15', 'Last Visit/Introduction by', 'Interaction Type', 
